...
# Pink or Insane Screen with Rendering      
...
(1) Generate new object to cut hole or to be cutted.      
(2) Change the sequence of cutting hole.      
(3) Re-try from start until there.      
...
(2) some frames later, change the location of object and save it with I key.            
