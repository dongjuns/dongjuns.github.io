...
If you made an object using nodes for the texture&surface,          
It can be an issue.         
...
And when you export the object, Set the Path Mode: Copy.            


# If the object is disappeared with increasing the camera or cahnge the parameter           
Change the clip start and clip end value as much as the size of your object.            
0.1 ~ 10 or 0.1 ~ 100.          
